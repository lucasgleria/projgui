        ...
        try:
            ...
            layout = [
                [sg.TabGroup([[
                    sg.Tab('Velocidade', [
                        [sg.Text("Velocidades: ")],
                        [sg.Text('X: '), sg.InputText(key="velx", tooltip="Set a value from 0 to 500")],
                        [sg.Text('Y: '), sg.InputText(key="vely", tooltip="Set a value from 0 to 500")],
                        [sg.Text('Z: '), sg.InputText(key="velz", tooltip="Set a value from 0 to 500")],
                        [sg.Button('Atualizar', key='-UPDATE_M203-')],  # Botão para atualizar velocidade
                        [sg.Button('Ajustar', key='ajust-vel')]
                    ]),
                    sg.Tab('Aceleração', [
                        [sg.Text("Acelerações: ")],
                        [sg.Text('X: '), sg.InputText(key="aclx", tooltip="Set a value from 0 to 500")],
                        [sg.Text('Y: '), sg.InputText(key="acly", tooltip="Set a value from 0 to 500")],
                        [sg.Text('Z: '), sg.InputText(key="aclz", tooltip="Set a value from 0 to 500")],
