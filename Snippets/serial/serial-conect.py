...
try:
    ...
    with sqlite3.connect("banco-testes-sem-imagem.db") as conn:
        cursor = conn.cursor()
                        ...
                        while True:
                            ...
                            if add_event == sg.WINDOW_CLOSED:
                                ...
                                if not nome:
                                    ...
                                    sg.popup('Campo Eixo X é obrigatório!\n\nPreencha com números inteiros.', title='Campo Obrigatório', non_blocking=True, font=(
                                        'Helvetica', 10), keep_on_top=True, auto_close_duration=3)
