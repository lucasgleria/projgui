...
def info_product_layout(has_selected_image=False, image_path=None):
    layout = [
        ...
        [sg.Button("Visualizar Imagem", key='visualizar_imagem'), sg.Button("Guardar Produto"), sg.Button("Retirar Produto")],
        [sg.Button('Voltar')],
    ]
                    ...
                    if selected_row:
                        ...
                        if product_info:
                            ...
                            while True:
                                ...
                                elif info_event == 'visualizar_imagem':
                                    if image_path and os.path.exists(image_path):
                                        display_image(image_path)
                                    else:
                                        sg.popup('Imagem não encontrada.', title='Erro', non_blocking=True, font=('Helvetica', 10), keep_on_top=True, auto_close_duration=3)
